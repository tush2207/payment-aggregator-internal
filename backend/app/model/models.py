...
class ApplicationsInDB(Base):
    ...
    email = Column("EMAIL", String(1020), nullable=True)
    mobileNo = Column(BigInteger, nullable=True)
    address = Column("ADDRESS", String(1020), nullable=True)
    integrateWith = Column(String(1020), nullable=True)
    category = Column("CATEGORY", String(1020), nullable=True)
    ...
    status = Column("STATUS", String(1020), nullable=True)
