from sqlalchemy import Column, Integer, String, Boolean, DateTime, Float, Sequence, LargeBinary
...
class ApplicationsInDB(Base):
    ...
    rccMailId = Column(String(255), nullable=True)
    rccMobileNo = Column(Integer, nullable=True)
    rccContactPersonName = Column(String(255), nullable=True)
    authorisedPersonName = Column(String(255), nullable=True)
    authorisedPersonDesignation = Column(String(255), nullable=True)
    branchName = Column(String(255), nullable=True)
